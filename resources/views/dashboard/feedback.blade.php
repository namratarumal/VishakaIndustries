        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <h5 class="card-title fw-semibold mb-4">Feedback Data</h5>
                        ...
                        <table id="dtBasicExample" class="table text-nowrap mb-0 align-middle table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-1">{{$f->email}}</h6>
                                    </td>
                                    <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-1">{{$f->mobile_no}}</h6>
                                    </td>
                                    <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-1">{{$f->address}}</h6>
                                    </td>
                                    <td class="border-bottom-0">
                                        <h6 class="fw-semibold mb-1">{{$f->description}}</h6>
                                    </td>
                                    
                                    <td class="border-bottom-0">
                                        <a href="deletefeedback/{{$f->id}}" class="btn btn-outline-danger btn-sm">Delete</a>
